    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="textarea-desc-ckeditor" name="description" maxlength="800" placeholder="Check List Group Description">{{ old('description', $checkListGroup->description ?? '') }}</textarea>
            </div>
            @if ($errors->any())
            <ul>
